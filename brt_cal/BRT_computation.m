...
% g =...
% 3d grid
grid_min = [-2; -4; -pi]; % Lower corner of computation domain
grid_max = [10; 4; pi];    % Upper corner of computation domain
N = [80; 80; 40];         % Number of grid points per dimension %180 180 80
