...
%% Controller params
ctr.phase_num = 4;
ctr.N = 80*2; % mpc period window
ctr.T = 3*2; % mpc period time
...
% Foot planner params
ctr.tar_body_vel = [0.3;0;0]; % x y z
ctr.tar_body_angular_vel = [0;0;0.2]; % r p y, only command yaw in this case
...
ctr.contact_state_ratio = ctr.N.*[1/ctr.gait_num 1/12 1/12 1/12 1/12 1/12 1/12 1/12 1/12 1/12 1/12 1/12]; % pull, jump, flight, impact
...
ctr.contact_state_val_trot = [repmat([1;0;0;1], 1, ctr.contact_state_ratio(1)),...
                           repmat([0;1;1;0], 1, ctr.contact_state_ratio(1))];
ctr.contact_state_val_bound = [repmat([1;1;1;1], 1, ctr.contact_state_ratio(1)),...
                           repmat([0;0;0;0], 1, ctr.contact_state_ratio(1))];
...
ctr.opt_setting.ipopt.print_level=5;
