...
ref_traj_v.x_ref_val(6,:) = interp1(s_a,s_b,ref_traj_v.x_ref_val(4,:),'spline'); % spline
...
ref_traj_v.x0 = [reshape(ref_traj_v.x_ref_val,body_p.state_dim*(ctr_p.N+1),1);...
                 ...
                 reshape(ref_traj_v.fp_ref_val,body_p.fp_dim*ctr_p.N,1)]; 
% pick a init state
% ref_traj_v.x0 = [reshape(ref_traj_v.x_ref_val(:,1), body_p.state_dim*1, 1);...
%                  reshape(ref_traj_v.f_ref_val(:,1), body_p.f_dim*1, 1);...
%                  reshape(ref_traj_v.fp_ref_val(:,1), body_p.fp_dim*1, 1)];       
end
