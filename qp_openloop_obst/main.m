...
[world_params, body_params, ctr_params, obst_params, path] = hardware_params();
...
[mpc_v, mpc_c, mpc_p] = form_mpc_prob(world_params, body_params, ctr_params, obst_params, dyn_f, path);
...
sol = mpc_p.solver('x0',ref_traj_v.x0,...
  ...
  %%
  rbt_anime(x_sol,f_sol,fp_g_sol,[],ctr_params.T,ctr_params.N, obst_params);
